...
- 🐱 Cat-themed shell messages and UI elements
- 🖥️ Improved compatibility with classic DOS games
- 📁 Improved directory mounting behavior
...
Mount a folder as a virtual DOS drive:
